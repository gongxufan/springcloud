package com.gxf.springcloud.client;


import com.gxf.springcloud.fallback.UserFeignClientFallbackFactory;
import com.gxf.springcloud.pojo.User;
...
/**
 * UserFeignClientFallbackFactory fabllback方法定义
